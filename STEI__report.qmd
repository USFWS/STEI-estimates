...
```{r}
#| label: fig-trendABR
#| fig-cap: "Posterior trend estimates for Steller's Eider in the ABR survey area, 1999-2023. The y axis is the log of the geometric mean growth rate, and the x axis is the lag-year trend, i.e.,  for lag 10 gives the 10-year trenf from 2013 to 2023. Posteriors describe as in other figures."
